...
\interests{{Big Data/3.2},{Full Stack Development/3.8},{System Architecture/4.5},{Software Engineering/4.5}}
...
\begin{twenty} % Environment for a list with descriptions
	...
	{}
	{
		{\begin{itemize}
				...
				\item Developed hubrid blog push app using Ionic, Angular and Express, users could like, comment and add blogs to favorite
		\end{itemize}}
	}
